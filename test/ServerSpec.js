  ...
  describe('Link creation:', function(){
    ...
    describe('Shortening links:', function(){
      ...
      xit('Fetches the link url title', function (done) {
        requestWithSession(options, function(error, res, body) {
          db.knex('urls')
            //not sure why this times out and the above doesn't
            .where('title', '=', 'Funny animal pictures, funny animals, funniest dogs')
            .then(function(urls) {
              console.log("MMMM " +urls[0][title]);
    ...
    describe('With previously saved urls:', function(){
      ...
      it('Shortcode redirects to correct url', function(done) {
        ...
        requestWithSession(options, function(error, res, body) {
          ...
          expect(currentLocation).to.equal('http://roflzoo.com/'); //roflzoo deleted it's www sub domain
          done();
        });
      });
